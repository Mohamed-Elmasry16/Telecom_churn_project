...
![API Docs](api_out3.png)
![API Docs](api_out4.png)
...
### **5. Model Analysis**
Visualizations from the `etisalat_task.ipynb` notebook, showcasing the feature importance, correlation matrices, and the impact of **SMOTE** on balancing the churn dataset.
